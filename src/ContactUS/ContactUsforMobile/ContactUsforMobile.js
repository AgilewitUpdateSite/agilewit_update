                ...
                <div className="SubHomeSecondLayer">
                    ...
                    <div className='MobileGooglemap'>
                        ...
                        <form className="MobileForm" onSubmit={SendMail}>
                            ...
                            <input type="text" value={Contact} placeholder="Phone" className="MobileEmail" name="number" pattern="[0-9]*" onChange={(e) => SetContact(e.target.value)} />
