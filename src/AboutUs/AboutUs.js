...
import {Patrtners,MissileItemsInfo} from '../Data/Data'
import PartnerOpinionItems from '../PartnerOpinionItems/PartnerOpinionItems'
import BottomPage from '../BottomPage/BottomPage'
import MissileItems from '../MissileItems/MissileItems'
        ...
        <div className='HomeTopLayer'>
            ...
            <div className='HomeSecondLayer'>
                ...
                <div className='SubHomeSecondLayer'>
                    ...
                    <div className='MissileItemsList'>
                            {MissileItemsInfo.map((each)=><MissileItems MissileItemsInfo={each}/>)}
                            </div>
